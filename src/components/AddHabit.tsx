        ...
        <>
            <div className={"create-habit-popup"}>
                ...
                <div className={"repeat-row"}>
                    ...
                    <select name="interval" id="interval" value={habitIntervalType} onChange={(e) => setHabitIntervalType(e.target.value)}>
                ...
                <button className={"create-habbit-button"} onClick={() => onSubmit(habitName, habitInterval, habitIntervalType)}>Create</button>
            </div>
        </>
